...
//? Собственный опыт. Когда циклы вложены и условие второго цикла (конкретно в данном примере) становится false, то этот второй цикл сбрасывает счетчик, а переменная i в первом цикле обновляет значение (в данном примере i увеличивается на 1 (i=1))
for (let i = 0; i < 5; i++) {
    for (let a = 0; a < 5; a++) {
        console.log(i, '', a)
    }
