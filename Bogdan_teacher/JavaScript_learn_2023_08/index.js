...
globalThis.console.log('with global')
...
//!!!но если у объекта которую мы хотим скопировать есть вложенные объекты, то ссылки на них сохраняются (другими словами вложенные объекты не копируются)
...
//та же особенность!!! если у объекта которую мы хотим скопировать есть вложенные объекты, то ссылки на них сохраняются (другими словами вложенные объекты не копируются)
...
//setTimeout(printMyName, 100) //setTimeout это встроенная ф-я, она позволяет выполнить ф-ю с задержкой
...
const newDonor = {
    ...dodnor, //разложили объект на свойства //если в объекте были такие же свойства, то они перезапишутсья, если стоят после оператор "..."
    lungs: true
}
...
console.log('Continue...') //это выражение не выполнится из-за ошибки на 550 строке
